...
export default function Services() {
  ...
  const services = [
    ...
    ["Telemedicine Solutions", "HD video consultations and remote care for better accessibility and convenience.", Video],
    ["Electronic Health Records", "Secure, digital, and interoperable health records accessible anytime, anywhere.", FileText],
    ...
    <div className="min-h-screen bg-white text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map(([title, desc, Icon]) => (
              <div
                key={title}
                className="bg-white border rounded-2xl p-8 text-center shadow-sm hover:shadow-xl transition"
              >
      ...
      <footer className="bg-blue-950 text-white">
        <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-5 gap-10">
          ...
          <FooterList
            title="Quick Links"
            items={["Home", "About", "Features", "Architecture", "Services", "Integrations", "Contact"]}
          />

          <FooterList
            title="Solutions"
            items={["Patient Management", "Hospital Management", "Telemedicine", "Pharmacy", "Insurance"]}
          />

          <FooterList
            title="Resources"
            items={["Documentation", "API Reference", "Guides", "Blog", "Case Studies"]}
          />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-blue-100">
              <li className="flex gap-2">
                <Mail size={16} /> info@meditech.com
              </li>
              <li className="flex gap-2">
                <Phone size={16} /> +1 (123) 456-7890
              </li>
              <li className="flex gap-2">
                <MapPin size={16} /> 123 HealthTech Street, San Francisco, CA 94107, USA
              </li>
            </ul>
          </div>
        </div>
